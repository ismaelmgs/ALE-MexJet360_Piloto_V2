<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmHorasVueloMatricula.aspx.cs" Inherits="ALE_MexJet.Views.Reportes.frmHorasVueloMatricula" UICulture="es" Culture="es-MX" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span style="color: #ffffff; font-family: Helvetica, Arial,sans-serif; font-size: 20px;">&nbsp;&nbsp;Horas de Vuelo por Matricula</span>
                    </div>
                </div>
                                ...
                                <div class="col-sm-12">
                                    <table style="width: 100%;">
                                        <tr>
                                            ...
                                            <td >
                                                <dx:ASPxRadioButtonList ID="rbSeleccion" runat="server" Theme="Office2010Black" ToolTip="Seleccion" 
                                                    ClientInstanceName="rbSeleccion" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="rbSeleccion_SelectedIndexChanged">
                                                    <Items>
                                                        <dx:ListEditItem Text="Cliente" Value="0" />
                                                        <dx:ListEditItem Text="Matricula" Value="1" />
                                                        <dx:ListEditItem Text="Flota" Value="2" />
                                                    </Items>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dx:ASPxLabel Theme="Office2010Black" Font-Bold="True" runat="server" Text="Flota:"></dx:ASPxLabel>
                                            </td>
                                            <td style="text-align: right">
                                                   <asp:UpdatePanel runat="server" ID="UpdatePanel3" UpdateMode="Conditional" OnUnload="UpdatePanel1_Unload">
                                                    <ContentTemplate>
                                                        <dx:ASPxComboBox ToolTip="Flota" ID="ddlFlota" NullText="Seleccione una Flota" runat="server" Theme="Office2010Black" EnableTheming="True">
                                                            <ValidationSettings Display="Dynamic" SetFocusOnError="True" CausesValidation="True" ErrorDisplayMode="Text" ValidationGroup="Grupo1">
                                                            </ValidationSettings>
                                                        </dx:ASPxComboBox>
                                                    </ContentTemplate>
                    ...
                    <div class="row">
                            <div class="col-md-12">
                                <asp:UpdatePanel runat="server" ID="UpdatePanel6" UpdateMode="Always" OnUnload="UpdatePanel1_Unload">
                                    <ContentTemplate>
                                        <div id="dVueloFlota" runat="server"></div>
                                    </ContentTemplate>
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="btnBusqueda" EventName="Click" />
                                    </Triggers>
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel5" OnUnload="UpdatePanel1_Unload">
                    <ContentTemplate>
                        ...
                        <dx:ASPxHiddenField ID="hfFlota" runat="server" />
