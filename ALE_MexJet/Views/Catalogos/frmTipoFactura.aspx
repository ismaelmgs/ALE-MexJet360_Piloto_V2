<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmTipoFactura.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmTipoFactura" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span style="color: #ffffff; font-family: Helvetica, Arial,sans-serif; font-size: 25px;">&nbsp;&nbsp;Tipo de Factura</span>
                    </div>
                </div>
                <div class="well-g">
                <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                        <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                                    ...
                                                    <asp:ListItem Text="Tipo Factura" Value="1"></asp:ListItem>
                                                    <asp:ListItem Text="Solo Activos" Value="2"></asp:ListItem>
                                                    <asp:ListItem Text="Solo Inactivos" Value="3"></asp:ListItem>
                                               </asp:DropDownList>
                                        </div>
                                         <div class="col-lg-4">
                                        <dx:ASPxButton ID="btnBusqueda" Text="Buscar" Theme="Office2010Black" runat="server" OnClick="btnBuscar_Click"></dx:ASPxButton>
                                    </div>                                                             
                              </div>
                        </fieldset>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                        <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                            <ContentTemplate>
                                <div class="col-sm-12">
                                    <dx:ASPxGridView ID="gvTipoFactura" runat="server" AutoGenerateColumns="False" Font-Size="Small"
                                        ClientInstanceName="gvTipoFactura" EnableTheming="True" KeyFieldName="IdTipoFactura"
                                        OnCellEditorInitialize="gvTipoFactura_CellEditorInitialize" OnRowDeleting="gvTipoFactura_RowDeleting"
                                        OnRowInserting="gvTipoFactura_RowInserting" OnRowUpdating="gvTipoFactura_RowUpdating" OnCommandButtonInitialize="gvTipoFactura_CommandButtonInitialize"
                                        OnStartRowEditing="gvTipoFactura_StartRowEditing" OnRowValidating="gvTipoFactura_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvTipoFactura_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="Tipo de Factura" FieldName="TipoFactura" ShowInCustomizationForm="True" VisibleIndex="0">
                                                ...
                                                <EditFormSettings Caption="Tipo de factura"></EditFormSettings>
                                            ...
                                            <dx:GridViewDataCheckColumn Caption="¿Bloquea Campos?" FieldName="BloqueaCampos" ShowInCustomizationForm="True" VisibleIndex="2" Visible="False">
                                                <PropertiesCheckEdit ValueChecked="1" ValueType="System.Int32" ValueUnchecked="0">
                                                </PropertiesCheckEdit>
                                                <EditFormSettings Visible="True"></EditFormSettings>
                                            </dx:GridViewDataCheckColumn>
                                            <dx:GridViewDataCheckColumn Caption="¿Disponible?" FieldName="Disponible" ShowInCustomizationForm="True" VisibleIndex="3" Visible="False">
                                                <PropertiesCheckEdit ValueChecked="1" ValueType="System.Int32" ValueUnchecked="0">
                                                </PropertiesCheckEdit>
                                                <EditFormSettings Visible="True"></EditFormSettings>
                                            </dx:GridViewDataCheckColumn>
                                            <dx:GridViewDataCheckColumn Caption="¿Requiere prefactura?" FieldName="RequierePrefactura" ShowInCustomizationForm="True" VisibleIndex="4" Visible="False">
                                                <PropertiesCheckEdit ValueChecked="1" ValueType="System.Int32" ValueUnchecked="0">
                                                </PropertiesCheckEdit>
                                                <EditFormSettings Visible="True"></EditFormSettings>
                                            </dx:GridViewDataCheckColumn>
                                            <dx:GridViewDataCheckColumn Caption="¿Aparece en tabulador?" FieldName="ApareceTabulador" ShowInCustomizationForm="True" VisibleIndex="5" Visible="False">
                                                <PropertiesCheckEdit ValueChecked="1" ValueType="System.Int32" ValueUnchecked="0">
                                                </PropertiesCheckEdit>
                                                <EditFormSettings Visible="True"></EditFormSettings>
                                            </dx:GridViewDataCheckColumn>
                                            <dx:GridViewDataCheckColumn Caption="¿Aparece en estado de cuenta?" FieldName="ApareceEstadoCuenta" ShowInCustomizationForm="True" VisibleIndex="6" Visible="False">
                                                <PropertiesCheckEdit ValueChecked="1" ValueType="System.Int32" ValueUnchecked="0">
                                                </PropertiesCheckEdit>
                                                <EditFormSettings Visible="True"></EditFormSettings>
                                            </dx:GridViewDataCheckColumn>
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvTipoFactura">
