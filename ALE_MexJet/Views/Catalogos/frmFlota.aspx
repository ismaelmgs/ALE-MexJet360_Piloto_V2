<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmFlota.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmFlota" %>
                    ...
                    <div class="row">
                        <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                            <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                                <ContentTemplate>
                                    <div class="col-sm-12">
                                        <dx:ASPxGridView CssClass="FGrid" ID="gvFlota" runat="server" ClientInstanceName="gvFlota" KeyFieldName="IdFlota" AutoGenerateColumns="False" 
                                            OnRowDeleting="gvFlota_RowDeleting" OnRowUpdating="gvFlota_RowUpdating" OnRowValidating="gvFlota_RowValidating" OnRowInserting="gvFlota_RowInserting" Styles-Header-HorizontalAlign="Center"
                                            SettingsBehavior-ConfirmDelete="true"
                                            OnStartRowEditing="gvFlota_StartRowEditing" 
                                            OnCellEditorInitialize="gvFlota_CellEditorInitialize" Width="100%" OnCancelRowEditing="gvFlota_CancelRowEditing" OnCommandButtonInitialize="gvFlota_CommandButtonInitialize"
                                        ...
                                        if (s.cpShowPopup)
                                        {
                                            ...
                                            <Columns>
                                                <dx:GridViewDataTextColumn FieldName="DescripcionFlota" Caption="Descripción" VisibleIndex="0">
                                                    <PropertiesTextEdit>
                                                ...
                                                <dx:GridViewDataComboBoxColumn FieldName="FlotaCU2" Caption="CU2" ShowInCustomizationForm="true" VisibleIndex="1" Visible="true">
                                                    <EditFormSettings Visible="True" />                                                    
                                                    <PropertiesComboBox  NullText="Seleccione una opci&#243;n" NullDisplayText="Seleccione una opci&#243;n">                                                       
                                                    </PropertiesComboBox>
                                                </dx:GridViewDataComboBoxColumn>

                                                <dx:GridViewDataCheckColumn FieldName="FlotaSENEAM" Caption="SENEAM" VisibleIndex="2"></dx:GridViewDataCheckColumn>
                                                <dx:GridViewDataCheckColumn FieldName="FlotaAPHIS" Caption="APHIS" VisibleIndex="3"></dx:GridViewDataCheckColumn>
                                                <dx:GridViewDataCheckColumn FieldName="Status" Caption="&quot;&#191;Activo?&quot;" VisibleIndex="4"></dx:GridViewDataCheckColumn>
                                                
                                                <dx:GridViewCommandColumn ShowEditButton ="true" ButtonType ="Button" ShowDeleteButton="True" Caption="Acciones" VisibleIndex="5"></dx:GridViewCommandColumn>
                                            </Columns>
                                        ...
                                        <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvFlota">
