<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmMotivo.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmMotivo" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Motivo</span>
                    </div>
                </div>
                <div class="well-g">
                <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                           <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                            ...
                                            <asp:ListItem Text="Motivo" Value="1"></asp:ListItem>
                ...
                <div class="col-md-12" style="margin-left:-15px;width:103%;">
                    <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                        <ContentTemplate>
                            <div class="col-sm-12">
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvMotivo" runat="server" AutoGenerateColumns="False" 
                                        ClientInstanceName="gvMotivo" EnableTheming="True" KeyFieldName="IdMotivo"
                                        OnCellEditorInitialize="gvMotivo_CellEditorInitialize" OnRowDeleting="gvMotivo_RowDeleting"
                                        OnRowInserting="gvMotivo_RowInserting" OnRowUpdating="gvMotivo_RowUpdating" OnCommandButtonInitialize="gvMotivo_CommandButtonInitialize"
                                        OnStartRowEditing="gvMotivo_StartRowEditing" OnRowValidating="gvMotivo_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvMotivo_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="Motivo" FieldName="DescripcionMotivo" ShowInCustomizationForm="True" VisibleIndex="1">
                                                ...
                                                <EditFormSettings Caption="Motivo"></EditFormSettings>
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvMotivo">
