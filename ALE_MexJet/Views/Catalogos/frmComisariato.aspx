<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmComisariato.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmComisariato" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Comisariato</span>
                    </div>
                </div>
                <div class="well-g">
                <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                      <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                            ...
                                            <asp:ListItem Text="Comisariato" Value="1"></asp:ListItem>
                ...
                <div class="row">
                    <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                        <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                            <ContentTemplate>
                                <div class="col-sm-12">
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvComisariato" runat="server" AutoGenerateColumns="False" 
                                        ClientInstanceName="gvComisariato" EnableTheming="True" KeyFieldName="ComisariatoId"
                                        OnCellEditorInitialize="gvComisariato_CellEditorInitialize" OnRowDeleting="gvComisariato_RowDeleting"
                                        OnRowInserting="gvComisariato_RowInserting" OnRowUpdating="gvComisariato_RowUpdating" OnCommandButtonInitialize="gvComisariato_CommandButtonInitialize"
                                        OnStartRowEditing="gvComisariato_StartRowEditing" OnRowValidating="gvComisariato_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvComisariato_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="Comisariato" FieldName="Descripcion" ShowInCustomizationForm="True" VisibleIndex="1">
                                                <PropertiesTextEdit>
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvComisariato">
