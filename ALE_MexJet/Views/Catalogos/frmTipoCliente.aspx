<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmTipoCliente.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmTipoCliente" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Tipo de Cliente</span>
                    </div>
                </div>
                <div class="well-g">
                <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                        <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                                        ...
                                                        <asp:ListItem Text="Tipo de Cliente" Value="1"></asp:ListItem>
                ...
                <div class="col-md-12" style="margin-left:-15px;width:103%;">
                    <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload ="Unnamed_Unload">
                        <ContentTemplate>
                                ...
                                <div class="col-sm-12">
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvTipoCliente" runat="server" AutoGenerateColumns="False" 
                                        ClientInstanceName="gvTipoCliente" EnableTheming="True" KeyFieldName="IdTipoCliente"
                                        OnCellEditorInitialize="gvTipoCliente_CellEditorInitialize" OnRowDeleting="gvTipoCliente_RowDeleting"
                                        OnRowInserting="gvTipoCliente_RowInserting" OnRowUpdating="gvTipoCliente_RowUpdating" OnCommandButtonInitialize="gvTipoCliente_CommandButtonInitialize"
                                        OnStartRowEditing="gvTipoCliente_StartRowEditing" OnRowValidating="gvTipoCliente_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvTipoCliente_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="Tipo de Cliente" FieldName="TipoClienteDescripcion" ShowInCustomizationForm="True" VisibleIndex="1">
                                                <PropertiesTextEdit DisplayFormatInEditMode="True" >
                                                    ...
                                                    <ValidationSettings ErrorDisplayMode="Text" CausesValidation="True" ErrorText="Error en la informaci&#243;n ingresada" ErrorTextPosition="Bottom" SetFocusOnError="True">
                                                        <RegularExpression ErrorText="El campo contiene informaci&#243;n inv&#225;lida." ValidationExpression="[a-zA-Z ]+"></RegularExpression>

                                                        <RequiredField IsRequired="True" ErrorText="El campo es requerido"></RequiredField>
                                                    </ValidationSettings>
                                                </PropertiesTextEdit>
                                                <EditFormSettings Caption="Tipo de cliente"></EditFormSettings>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Código Financiero" FieldName="CodigoDeUnidad4Descripcion" ShowInCustomizationForm="True" VisibleIndex="2">
                                                <PropertiesTextEdit DisplayFormatInEditMode="True">
                                                    <InvalidStyle>
                                                        <Border BorderColor="Red" />
                                                    </InvalidStyle>
                                            ...
                                            <dx:GridViewDataComboBoxColumn Caption="Código Financiero" FieldName="CodigoDeUnidad4" ShowInCustomizationForm="True" VisibleIndex="3" Visible="False">
                                                ...
                                                <EditFormSettings Visible="True" Caption="Código Financiero"></EditFormSettings>
                                            </dx:GridViewDataComboBoxColumn>
                                            <dx:GridViewDataTextColumn  Caption="Horas Pernocta" FieldName="HrsPernocta" ShowInCustomizationForm="True" VisibleIndex="4">
                                                <PropertiesTextEdit DisplayFormatInEditMode="True" MaxLength="2" >
                                                    <InvalidStyle>
                                                        <Border BorderColor="Red" />
                                                    </InvalidStyle>
                                                    <ValidationSettings ErrorDisplayMode="Text" CausesValidation="True" ErrorTextPosition="Bottom">
                                                        <RegularExpression ValidationExpression ="[0-9]*" ErrorText="Error en la información ingresada"  />
                                                    </ValidationSettings>
                                                </PropertiesTextEdit>
                                                <EditFormSettings Caption="Horas Pernocta"></EditFormSettings>
                                            </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvTipoCliente">
