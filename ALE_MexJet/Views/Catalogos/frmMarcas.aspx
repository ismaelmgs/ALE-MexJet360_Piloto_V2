<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmMarcas.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmMarcas" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Marcas</span>
                    </div>
                </div>
                  <div class="well-g">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" OnUnload ="UpdatePanel1_Unload">
                                <ContentTemplate>
                                    <div class="col-sm-12">
                                        <dx:ASPxGridView CssClass="FGrid" ID="gvMArcas" runat="server" AutoGenerateColumns="False"
                                            ClientInstanceName="gvMArcas" EnableTheming="True" KeyFieldName="IdMarca"
                                            OnRowDeleting="gvMArcas_RowDeleting" OnRowUpdating="gvMArcas_RowUpdating"
                                            OnRowInserting="gvMArcas_RowInserting" OnStartRowEditing="gvRol_StartRowEditing" OnCommandButtonInitialize="gvMArcas_CommandButtonInitialize"
                                            OnRowValidating="gvMArcas_RowValidating1"  OnCellEditorInitialize="gvMArcas_CellEditorInitialize" Styles-Header-HorizontalAlign ="Center"
                                            Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvMArcas_CancelRowEditing">
                                            ...
                                            <Columns>
                                               ...
                                               <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="DescripcionMarca" ShowInCustomizationForm="True" VisibleIndex="1" Caption="Descripci&#243;n">
                                        ...
                                        <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvMArcas">
