<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmTipoContacto.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmTipoContacto" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Tipo Contacto</span>
                    </div>
                </div>
                <div class="well-g">
                <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                        <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                                    ...
                                                    <asp:ListItem Text="Tipo contacto" Value="1"></asp:ListItem>
                ...
                <div class="row">
                    <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                        <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                            <ContentTemplate>
                                <div class="col-sm-12">
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvTipoContacto" runat="server" AutoGenerateColumns="False" 
                                        ClientInstanceName="gvTipoContacto" EnableTheming="True" KeyFieldName="IdTipoContacto"
                                        OnCellEditorInitialize="gvTipoContacto_CellEditorInitialize" OnRowDeleting="gvTipoContacto_RowDeleting"
                                        OnRowInserting="gvTipoContacto_RowInserting" OnRowUpdating="gvTipoContacto_RowUpdating" OnCommandButtonInitialize="gvTipoContacto_CommandButtonInitialize"
                                        OnStartRowEditing="gvTipoContacto_StartRowEditing" OnRowValidating="gvTipoContacto_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvTipoContacto_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="Tipo de Contacto" FieldName="TipoContactoDescripcion" ShowInCustomizationForm="True" VisibleIndex="1">
                                                ...
                                                <EditFormSettings Caption="Tipo de contacto"></EditFormSettings>
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvTipoContacto">
