<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmTitulo.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmTitulo" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;T&iacute;tulo</span>
                    </div>
                </div>
              <div class="well-g">
                <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                        <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                                        ...
                                                        <asp:ListItem Text="T&iacute;tulo" Value="2"></asp:ListItem>
                ...
                <div class="col-md-12" style="margin-left:-15px;width:103%;">
                    <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                        <ContentTemplate>
                                <div class="col-sm-12">
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvTitulo" runat="server" AutoGenerateColumns="False" 
                                        ClientInstanceName="gvTitulo" EnableTheming="True" KeyFieldName="IdTitulo"
                                        OnCellEditorInitialize="gvTitulo_CellEditorInitialize" OnRowDeleting="gvTitulo_RowDeleting"
                                        OnRowInserting="gvTitulo_RowInserting" OnRowUpdating="gvTitulo_RowUpdating" OnCommandButtonInitialize="gvTitulo_CommandButtonInitialize"
                                        OnStartRowEditing="gvTitulo_StartRowEditing" OnRowValidating="gvTitulo_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvTitulo_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="T&iacute;tulo" FieldName="TituloDescripcion" ShowInCustomizationForm="True" VisibleIndex="1">
                                                ...
                                                <EditFormSettings Caption="T&iacute;tulo"></EditFormSettings>
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvTitulo">
