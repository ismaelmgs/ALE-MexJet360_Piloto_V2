<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmInflacion.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmInflacion" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
               <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Inflación</span>
                    </div>
                </div>
                 <div class="well-g">
                 <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                                      <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                                        ...
                                                        <asp:ListItem Text="Tipo de Inflación" Value="2"></asp:ListItem>
                ...
                <div class="col-md-12" style="margin-left:-15px;width:103%;">
                    <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                        <ContentTemplate>
                                ...
                                <div class="col-sm-12">
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvInflacion" runat="server" AutoGenerateColumns="False" 
                                        ClientInstanceName="gvInflacion" EnableTheming="True" KeyFieldName="IdInflacion"
                                        OnCellEditorInitialize="gvInflacion_CellEditorInitialize" OnRowDeleting="gvInflacion_RowDeleting"
                                        OnRowInserting="gvInflacion_RowInserting" OnRowUpdating="gvInflacion_RowUpdating" OnCommandButtonInitialize="gvInflacion_CommandButtonInitialize"
                                        OnStartRowEditing="gvInflacion_StartRowEditing" OnRowValidating="gvInflacion_RowValidating" Styles-Header-HorizontalAlign ="Center" OnDetailRowExpandedChanged="gvInflacion_DetailRowExpandedChanged"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvInflacion_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="Tipo de Inflaci&#243;n" FieldName="TipoInflacion" ShowInCustomizationForm="True" VisibleIndex="1">
                                                <EditFormSettings Caption="Tipo de Inflaci&#243;n"></EditFormSettings>
                                        ...
                                        <Templates>
                                            <DetailRow>
                                                <dx:ASPxGridView CssClass="FGrid" ID="gvDetalle" runat="server" KeyFieldName="IdInflacionDetalle" Theme="Office2010Black" Width="100%" AutoGenerateColumns="False"
                                                        ClientInstanceName="gvDetalle" EnableTheming="True"
                                                        StylesPopup-EditForm-ModalBackground-Opacity="90" OnCommandButtonInitialize="gvDetalle_CommandButtonInitialize" OnRowUpdating="gvDetalle_RowUpdating"
                                                        OnRowInserting="gvDetalle_RowInserting" OnStartRowEditing="gvDetalle_StartRowEditing" OnCellEditorInitialize="gvDetalle_CellEditorInitialize"
                                                        Styles-Header-HorizontalAlign="Center" OnRowValidating="gvDetalle_RowValidating" OnRowDeleting="gvDetalle_RowDeleting"
                                                        ...
                                                        <Columns>                                                            
                                                            ...
                                                            <dx:GridViewDataTextColumn FieldName="Año" Caption="Año" VisibleIndex="2">
                                                                <PropertiesTextEdit MaxLength="50">
                                                            ...
                                                            <dx:GridViewDataTextColumn FieldName="Porcentaje" Caption="Porcentaje" VisibleIndex="3">
                                                                <PropertiesTextEdit MaxLength="50">
                                                                    <ValidationSettings ErrorDisplayMode="Text" ErrorText="Error en la informaci&#243;n ingresada" ErrorTextPosition="Bottom" SetFocusOnError="True">
                                                                        <ErrorFrameStyle BackColor="Red"></ErrorFrameStyle>
                                                                        <RegularExpression />
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvInflacion">
