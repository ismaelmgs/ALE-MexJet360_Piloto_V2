<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmTipoPierna.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmTipoPierna" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Tipo de Pierna</span>
                    </div>
                </div>
                <div class="well-g">
                <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                        <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                                    ...
                                                    <asp:ListItem Text="Tipo de Pierna" Value="2"></asp:ListItem>
                ...
                <div class="row">
                    <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                        <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                            <ContentTemplate>
                                <div class="col-sm-12">
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvTipoPierna" runat="server" AutoGenerateColumns="False"
                                        ClientInstanceName="gvTipoPierna" EnableTheming="True" KeyFieldName="IdTipoPierna"
                                        OnCellEditorInitialize="gvTipoPierna_CellEditorInitialize" OnRowDeleting="gvTipoPierna_RowDeleting"
                                        OnRowInserting="gvTipoPierna_RowInserting" OnRowUpdating="gvTipoPierna_RowUpdating" OnCommandButtonInitialize="gvTipoPierna_CommandButtonInitialize"
                                        OnStartRowEditing="gvTipoPierna_StartRowEditing" OnRowValidating="gvTipoPierna_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvTipoPierna_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="Tipo de pierna" FieldName="TipoPiernaDescripcion" ShowInCustomizationForm="True" VisibleIndex="1">
                                                <PropertiesTextEdit>
                                                    <ValidationSettings ErrorDisplayMode="Text" CausesValidation="True" ErrorText="Error en la informac&#243;n ingresada" ErrorTextPosition="Bottom" SetFocusOnError="True">
                                                        <RegularExpression ErrorText="El campo contiene informaci&#243;n inv&#225;lida." ValidationExpression="[a-zA-Z ñÑáéíóúÁÉÍÓÚ|-]*"></RegularExpression>
                                                        <RequiredField IsRequired="True" ErrorText="El campo es requerido"></RequiredField>
                                                    </ValidationSettings>
                                                </PropertiesTextEdit>
                                                <EditFormSettings Caption="Tipo de Pierna"></EditFormSettings>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Paquete" FieldName="Paquete" ShowInCustomizationForm="True" VisibleIndex="1">
                                                <EditFormSettings Visible ="False" />
                                            </dx:GridViewDataTextColumn>
                                             <dx:GridViewDataComboBoxColumn Caption="Paquete" FieldName="IdTipoPaquete" ShowInCustomizationForm="True" Visible ="false" VisibleIndex="1">
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvTipoPierna">
