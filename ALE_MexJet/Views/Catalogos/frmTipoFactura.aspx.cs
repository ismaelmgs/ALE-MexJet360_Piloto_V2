...
namespace ALE_MexJet.Views.Catalogos
{
    public partial class frmTipoFactura : System.Web.UI.Page, IViewCat
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                DrPermisos = Utils.ObtenerPermisos(Enumeraciones.Pantallas.TipoFactura);
                LoadActions(DrPermisos);
                gvTipoFactura.Columns["Status"].Visible = true;
                //gvTipoFactura.SettingsText.PopupEditFormCaption = "Formulario de Edición";
                ...
                gvTipoFactura.SettingsText.SearchPanelEditorNullText = "Ingrese la información a buscar";
                ...
                if (!IsPostBack)
                {
                    if (gvTipoFactura.VisibleRowCount < 1)
                    {
                        ...
                        gvTipoFactura.SettingsText.PopupEditFormCaption = "Formulario de Creación";
        ...
        protected void gvTipoFactura_CancelRowEditing(object sender, ASPxStartRowEditingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoFactura_CancelRowEditing", "Aviso");
            }
        ...
        protected void gvTipoFactura_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoFactura_CellEditorInitialize", "Aviso");
            }
        }
        ...
        protected void gvTipoFactura_RowDeleting(object sender, ASPxDataDeletingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoFactura_RowDeleting", "Aviso");
            }
        }
        ...
        protected void gvTipoFactura_RowInserting(object sender, ASPxDataInsertingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoFactura_RowInserting", "Aviso");
            }
        ...
        protected void gvTipoFactura_RowUpdating(object sender, ASPxDataUpdatingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoFactura_RowUpdating", "Aviso");
            }
        ...
        protected void gvTipoFactura_StartRowEditing(object sender, ASPxStartRowEditingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoFactura_StartRowEditing", "Aviso");
            }
        }
        ...
        protected void gvTipoFactura_RowValidating(object sender, ASPxDataValidationEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoFactura_RowValidating", "Aviso");
            }
        }
        ...
        protected void gvTipoFactura_CommandButtonInitialize(object sender, ASPxGridViewCommandButtonEventArgs e)
        {
            try
            {
                int iPos = 0;
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoFactura_CommandButtonInitialize", "Aviso");
            }
        }
        ...
        private const string sClase = "frmTipoFactura.aspx.cs";
        private const string sPagina = "frmTipoFactura.aspx";
