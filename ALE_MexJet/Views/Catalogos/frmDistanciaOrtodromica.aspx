<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmDistanciaOrtodromica.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmDistanciaOrtodromica" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnSaveClick(s, e) {
            gvDistanciaOrtodromica.UpdateEdit();
        }
    </script>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Distancia Ortodrómica</span>
                    </div>
                </div>
                <div class="well-g">
                    <div class="row">
                        ...
                        <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                            <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                                <ContentTemplate>
                                    ...
                                    <div class="col-sm-12">
                                        <dx:ASPxGridView CssClass="FGrid" ID="gvDistanciaOrtodromica" runat="server" AutoGenerateColumns="False" 
                                            ClientInstanceName="gvDistanciaOrtodromica" EnableTheming="True" KeyFieldName="IdDistanciaOrtodomica"
                                            OnCellEditorInitialize="gvDistanciaOrtodromica_CellEditorInitialize" 
                                            OnRowDeleting="gvDistanciaOrtodromica_RowDeleting"
                                            OnRowInserting="gvDistanciaOrtodromica_RowInserting" 
                                            OnRowUpdating="gvDistanciaOrtodromica_RowUpdating"
                                            OnStartRowEditing="gvDistanciaOrtodromica_StartRowEditing" 
                                            OnRowValidating="gvDistanciaOrtodromica_RowValidating" 
                                            OnCommandButtonInitialize="gvDistanciaOrtodromica_CommandButtonInitialize"
                                            Styles-Header-HorizontalAlign="Center"
                                            Theme="Office2010Black" Width="100%" 
                                            StylesPopup-EditForm-ModalBackground-Opacity="90" 
                                            OnCancelRowEditing="gvDistanciaOrtodromica_CancelRowEditing">
                                        ...
                                        if (s.cpShowPopup)
                                        {
                                            ...
                                            <Columns>
                                                <dx:GridViewDataColumn FieldName ="Origen" Caption ="Origen" Visible ="true" VisibleIndex ="1">
                                                    <EditFormSettings Visible ="False" />
                                                </dx:GridViewDataColumn>
                                                <dx:GridViewDataComboBoxColumn FieldName="IdOrigen" Caption="Origen" VisibleIndex="1" PropertiesComboBox-ValueType="System.Int32" Visible ="false">
                                                ...
                                                <dx:GridViewDataColumn FieldName ="Destino" Caption ="Destino" Visible ="true" VisibleIndex ="2">
                                                    <EditFormSettings Visible ="False" />
                                                </dx:GridViewDataColumn>
                                                <dx:GridViewDataComboBoxColumn FieldName="IdDestino" Caption="Destino" VisibleIndex="2" PropertiesComboBox-ValueType="System.Int32" Visible ="false">
                                                    <PropertiesComboBox ValueType="System.Int32"
                                                ...
                                                <dx:GridViewDataTextColumn Caption="Distancia en Km." FieldName="DistanciaKms" ShowInCustomizationForm="True" VisibleIndex="3">
                                                    <PropertiesTextEdit>
                                                        <ValidationSettings ErrorDisplayMode="Text" ErrorText="Error en la informaci&#243;n ingresada." ErrorTextPosition="Bottom" SetFocusOnError="True">
                                                    ...
                                                    <EditFormSettings Caption="Distancia en Km."></EditFormSettings>
                                        ...
                                        <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvDistanciaOrtodromica">
