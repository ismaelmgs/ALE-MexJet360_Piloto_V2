...
namespace ALE_MexJet.Views.Catalogos
{
    public partial class frmTipoContacto : System.Web.UI.Page, IViewCat
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                DrPermisos = Utils.ObtenerPermisos(Enumeraciones.Pantallas.TipoContacto);
                ...
                gvTipoContacto.SettingsText.SearchPanelEditorNullText = "Ingrese la información a buscar";
                ...
                if (!IsPostBack)
                {
                    if (gvTipoContacto.VisibleRowCount < 1)
                    {
                        ...
                        gvTipoContacto.SettingsText.PopupEditFormCaption = "Formulario de Creación";
        ...
        protected void gvTipoContacto_CancelRowEditing(object sender, ASPxStartRowEditingEventArgs e)
        {
            try
            {
                gvTipoContacto.Columns["Status"].Visible = true;
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoContacto_CancelRowEditing", "Aviso");
            }
        ...
        protected void gvTipoContacto_CellEditorInitialize(object sender, DevExpress.Web.ASPxGridViewEditorEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoContacto_CellEditorInitialize", "Aviso");
            }
        }
        ...
        protected void gvTipoContacto_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoContacto_RowDeleting", "Aviso");
            }
        ...
        protected void gvTipoContacto_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoContacto_RowUpdating", "Aviso");
            }
        }
        ...
        protected void gvTipoContacto_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoContacto_RowInserting", "Aviso");
            }
        ...
        protected void gvTipoContacto_StartRowEditing(object sender, DevExpress.Web.Data.ASPxStartRowEditingEventArgs e)
        {
            try
            {
                gvTipoContacto.SettingsText.PopupEditFormCaption = "Formulario de Edición";
            }
            catch (Exception ex)
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoContacto_StartRowEditing", "Aviso");
            }
        }
        ...
        protected void gvTipoContacto_RowValidating(object sender, DevExpress.Web.Data.ASPxDataValidationEventArgs e)
        {
            try
            {
                ...
                if (bDuplicado)
                {
                    AddError(e.Errors, gvTipoContacto.Columns["TipoContactoDescripcion"], "Esta descripción de contacto ya existe, favor de validarlo.");
                }
            }
            catch (Exception ex)
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoContacto_RowValidating", "Aviso");
            }
        }
        ...
        protected void gvTipoContacto_CommandButtonInitialize(object sender, ASPxGridViewCommandButtonEventArgs e)
        {
            try
            {
                int iPos = 0;
        ...
        private const string sClase = "frmTipoContacto.aspx.cs";
        private const string sPagina = "frmTipoContacto.aspx";
