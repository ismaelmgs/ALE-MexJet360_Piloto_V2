<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmProducto.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmProducto" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Producto</span>
                    </div>
                </div>
                <div class="well-g">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                            <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                                <ContentTemplate>
                                    <div class="col-sm-12">
                                        <dx:ASPxGridView CssClass="FGrid" ID="gvProducto" runat="server" AutoGenerateColumns="False"
                                            ClientInstanceName="gvProducto" EnableTheming="True" KeyFieldName="IdProducto"
                                            OnCellEditorInitialize="gvProducto_CellEditorInitialize" OnRowDeleting="gvProducto_RowDeleting"
                                            OnRowInserting="gvProducto_RowInserting" OnRowUpdating="gvProducto_RowUpdating" OnCommandButtonInitialize="gvProducto_CommandButtonInitialize"
                                            OnStartRowEditing="gvProducto_StartRowEditing" OnRowValidating="gvProducto_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                            Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvProducto_CancelRowEditing">
                                        ...
                                        if (s.cpShowPopup)
                                        {
                                            ...
                                            <Columns>
                                                <dx:GridViewDataTextColumn Caption="Producto" FieldName="ProductoDescripcion" ShowInCustomizationForm="True" VisibleIndex="1">
                                                    <PropertiesTextEdit>
                                                    ...
                                                    <EditFormSettings Caption="Producto"></EditFormSettings>
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataComboBoxColumn Caption="Tipo de Producto" FieldName="TipoProductoDescripcion" VisibleIndex="3">
                                                ...
                                                <dx:GridViewDataComboBoxColumn Caption="Tipo de producto" FieldName="IdTipoProducto" VisibleIndex="3" Visible="false">
                                                    <EditFormSettings Visible="True" />
                                                    <PropertiesComboBox ValueType="System.Int32" NullText="Seleccione una opción" ValueField="IdTipoProducto">
                                                        <ValidationSettings ErrorDisplayMode="Text" CausesValidation="True" ErrorText="Error en la informaci&#243;n ingresada" ErrorTextPosition="Bottom" SetFocusOnError="True">
                                                            <RequiredField IsRequired="True" ErrorText="El campo es requerido"></RequiredField>
                                                        </ValidationSettings>
                                                    </PropertiesComboBox>
                                        ...
                                        <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvProducto">
