<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmArea.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmArea" %>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4"> 
                                             <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                                        ...
                                                        <asp:ListItem Text="Área" Value="1"></asp:ListItem>
                ...
                <div class="col-md-12" style="margin-left:-15px;width:103%;">
                    <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload ="Unnamed_Unload">
                        <ContentTemplate>
                                ...
                                <div class="col-sm-12">
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvArea" runat="server" AutoGenerateColumns="False" Font-Size="Small"
                                        ClientInstanceName="gvArea" EnableTheming="True" KeyFieldName="IdArea"
                                        OnCellEditorInitialize="gvArea_CellEditorInitialize" OnRowDeleting="gvArea_RowDeleting"
                                        OnRowInserting="gvArea_RowInserting" OnRowUpdating="gvArea_RowUpdating"
                                        OnStartRowEditing="gvArea_StartRowEditing" OnRowValidating="gvArea_RowValidating" Styles-Header-HorizontalAlign ="Center" OnCommandButtonInitialize="gvArea_CommandButtonInitialize"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvArea_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="Área" FieldName="AreaDescripcion" ShowInCustomizationForm="True" VisibleIndex="1">
                                                <PropertiesTextEdit DisplayFormatInEditMode="True" >
                                                    <InvalidStyle>
                                                        <Border BorderColor="Red" />
                                                    </InvalidStyle>
                                                    <ValidationSettings ErrorDisplayMode="Text" ErrorTextPosition="Bottom" SetFocusOnError="True" CausesValidation="True" ErrorText="Error en la informaci&#243;n ingresada.">
                                                        <RegularExpression ErrorText="El campo contiene informaci&#243;n inv&#225;lida." ValidationExpression =""></RegularExpression>

                                                        <RequiredField ErrorText="El campo es requerido." IsRequired="True" />
                                                    </ValidationSettings>
                                                </PropertiesTextEdit>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="Email" FieldName="AreaEmail" ShowInCustomizationForm="True" VisibleIndex="2">
                                                <PropertiesTextEdit DisplayFormatInEditMode="True" MaxLength="100" >
                                                    <MaskSettings ShowHints="True"></MaskSettings>
                                                    <InvalidStyle>
                                                        <Border BorderColor="Red" />
                                                    </InvalidStyle>
                                                    <ValidationSettings ErrorDisplayMode="Text" ErrorTextPosition="Bottom" SetFocusOnError="True" ErrorText="Error en la informaci&#243;n ingresada">
                                                        <RegularExpression ErrorText="El campo solo permite correos electrónicos en minúsculas." ValidationExpression="^[_a-z0-9-]+(.[_a-z0-9-]+)*@[a-z0-9-]+(.[a-z0-9-]+)*(.[a-z]{2,4})$" />
                                                        <RequiredField ErrorText="El campo es requerido." IsRequired="True" />
                                                    </ValidationSettings>
                                                </PropertiesTextEdit>

                                                <EditFormSettings Caption="Email"></EditFormSettings>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataTextColumn Caption="EmailCC" FieldName="AreaEmailCC" ShowInCustomizationForm="True" VisibleIndex="3">

                                                <PropertiesTextEdit DisplayFormatInEditMode="True" MaxLength="100" NullDisplayText="">
                                                    <InvalidStyle>
                                                        <Border BorderColor="Red" />
                                                    </InvalidStyle>
                                                    <ValidationSettings ErrorDisplayMode="Text" ErrorTextPosition="Bottom" SetFocusOnError="True" ErrorText="Error en la informaci&#243;n ingresada">
                                                ...
                                                <EditFormSettings Caption="EmailCC"></EditFormSettings>
                                            </dx:GridViewDataTextColumn>
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvArea">
