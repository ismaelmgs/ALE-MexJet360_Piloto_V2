<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmMembresias.aspx.cs" Inherits="ALE_MexJet.Views.Catalogos.frmMembresias" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Membresias</span>
                    </div>
                </div>
                  <div class="well-g">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" OnUnload ="UpdatePanel1_Unload">
                                <ContentTemplate>
                                    <div class="col-sm-12">
                                        <dx:ASPxGridView CssClass="FGrid" ID="gvMembresias" runat="server" AutoGenerateColumns="False"
                                            ClientInstanceName="gvMembresias" EnableTheming="True" KeyFieldName="IdMembresia"
                                            OnRowDeleting="gvMembresias_RowDeleting" OnRowUpdating="gvMembresias_RowUpdating"
                                            OnRowInserting="gvMembresias_RowInserting" OnStartRowEditing="gvMembresias_StartRowEditing" OnCommandButtonInitialize="gvMembresias_CommandButtonInitialize"
                                            OnRowValidating="gvMembresias_RowValidating1"  OnCellEditorInitialize="gvMembresias_CellEditorInitialize" Styles-Header-HorizontalAlign ="Center"
                                            Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvMembresias_CancelRowEditing">
                                            ...
                                            <Columns>
                                               ...
                                               <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="CodigoMembresia" ShowInCustomizationForm="True" VisibleIndex="1" Caption="Codigo Membresia">
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="DescripcionMembresia" ShowInCustomizationForm="True" VisibleIndex="1" Caption="Descripci&#243;n">
                                                ...
                                                <dx:GridViewDataCheckColumn FieldName="Status" ShowInCustomizationForm="True" VisibleIndex="2" Caption="¿Activo?">
                                        ...
                                        <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvMembresias">
