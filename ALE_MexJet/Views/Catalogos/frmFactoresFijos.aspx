<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmFactoresFijos.aspx.cs" Inherits="ALE_MexJet.Views.Catalogos.frmFactoresFijos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnSaveClick(s, e) {
            gvFactoresFijos.UpdateEdit();
        }
    </script>
    <dx:ASPxPanel ID="ASPxPanel3" runat="server" Width="100%" BackColor="White" style="border-radius:21px;">
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Factores Fijos</span>
                    </div>
                </div>
                <div class="well-g">
                    <div class="row">
                            ...
                            <fieldset class="Personal">
                              <legend>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                        <dx:ASPxButton CssClass="FBotton" ID="btnBuscar" Text="Buscar" Theme="Office2010Black" runat="server"
                                            OnClick="btnBuscar_Click"></dx:ASPxButton> 
                                    </div>                                                             
                              </div>
                            </fieldset>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <dx:ASPxButton CssClass="FBotton" ID="btnNuevo" runat="server" Text="Nuevo" Theme="Office2010Black" OnClick="btnNuevo_Click" ></dx:ASPxButton> <%--OnClick="btnNuevo_Click"--%>
                        </div>
                        <div class="col-md-6" style="text-align: right;">
                            <dx:ASPxLabel CssClass="FExport" runat="server" Theme="Office2010Black" Text="Exportar a:"></dx:ASPxLabel>
                            &nbsp;<dx:ASPxButton CssClass="FBotton" ID="btnExcel" runat="server" Text="Excel" Theme="Office2010Black" OnClick="btnExcel_Click"></dx:ASPxButton> <%--OnClick="btnExcel_Click"--%>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" OnUnload ="UpdatePanel1_Unload">
                                <ContentTemplate>
                                    <div class="col-sm-12">
                                        <dx:ASPxGridView CssClass="FGrid" ID="gvFactoresFijos" runat="server" AutoGenerateColumns="False"
                                            ClientInstanceName="gvFactoresFijos" EnableTheming="True" KeyFieldName="IdFactor"
                                            OnRowDeleting="gvFactoresFijos_RowDeleting" OnRowUpdating="gvFactoresFijos_RowUpdating"
                                            OnRowInserting="gvFactoresFijos_RowInserting" OnStartRowEditing="gvFactoresFijos_StartRowEditing" OnCommandButtonInitialize="gvFactoresFijos_CommandButtonInitialize"
                                            OnRowValidating="gvFactoresFijos_RowValidating"  OnCellEditorInitialize="gvFactoresFijos_CellEditorInitialize" Styles-Header-HorizontalAlign ="Center"
                                            Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvFactoresFijos_CancelRowEditing">
                                            ...
                                            <Columns>
                                               <dx:GridViewCommandColumn ShowInCustomizationForm="True" VisibleIndex="5" ShowEditButton="true" ShowDeleteButton="true" ButtonType="Button" Caption="Acciones">
                                               <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                               </dx:GridViewCommandColumn>
                                                <dx:GridViewDataTextColumn FieldName="Clave" ShowInCustomizationForm="True" VisibleIndex="1" Caption="Clave">
                                                    ...
                                                    <EditFormSettings Caption="Clave"></EditFormSettings>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="Valor" ShowInCustomizationForm="True" VisibleIndex="3" Caption="Valor">
                                                    <PropertiesTextEdit MaxLength="200">
                                                        <ValidationSettings ErrorDisplayMode="Text" CausesValidation="True" ErrorText="Error en la informaci&#243;n ingresada." ErrorTextPosition="Bottom" SetFocusOnError="True">
                                                    ...
                                                    <EditFormSettings Caption="Valor"></EditFormSettings>
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataCheckColumn FieldName="Sts" ShowInCustomizationForm="True" VisibleIndex="4" Caption="¿Activo?">
                                        ...
                                        <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvFactoresFijos">
