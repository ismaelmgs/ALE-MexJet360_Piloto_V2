<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmFechaPico.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmFechaPico" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp; Días Pico</span>
                    </div>
                </div>
                <div class="well-g">
                    <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                        <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                            ...
                                            <asp:ListItem Text="Fecha" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                            <asp:UpdatePanel runat="server" UpdateMode="Always" ID="UpdFechaPico" OnUnload="Unnamed_Unload">
                                <ContentTemplate>
                                    <div class="col-sm-12">
                                        <dx:ASPxGridView CssClass="FGrid" ID="gvFechaPico" runat="server" AutoGenerateColumns="False" 
                                            ClientInstanceName="gvFechaPico" EnableTheming="True" KeyFieldName="IdFechaPico"
                                            OnCellEditorInitialize="gvFechaPico_CellEditorInitialize" OnRowDeleting="gvFechaPico_RowDeleting"
                                            OnRowInserting="gvFechaPico_RowInserting" OnRowUpdating="gvFechaPico_RowUpdating" OnCommandButtonInitialize="gvFechaPico_CommandButtonInitialize"
                                            OnStartRowEditing="gvFechaPico_StartRowEditing" OnRowValidating="gvFechaPico_RowValidating"
                                        ...
                                        if (s.cpShowPopup)
                                        {
                                            ...
                                            <Columns>
                                                <dx:GridViewDataDateColumn Caption="Fecha" FieldName="Fecha" ShowInCustomizationForm="True" VisibleIndex="1" CellStyle-HorizontalAlign="Left" PropertiesDateEdit-ValidationSettings-RequiredField-IsRequired="true">
                                                    <PropertiesDateEdit DisplayFormatString="d" NullText="Seleccione fecha">
                                        ...
                                        <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvFechaPico">
