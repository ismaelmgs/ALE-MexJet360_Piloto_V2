...
{
    public partial class frmTipoPierna : System.Web.UI.Page, iViewTipoPierna
    {
        #region EVENTOS
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                DrPermisos = Utils.ObtenerPermisos(Enumeraciones.Pantallas.TipoPierna);
                ...
                gvTipoPierna.SettingsText.SearchPanelEditorNullText = "Ingrese la información a buscar";
                ...
                if (!IsPostBack)
                {
                    if (gvTipoPierna.VisibleRowCount < 1)
                    {
                        ...
                        gvTipoPierna.SettingsText.PopupEditFormCaption = "Formulario de Creación";
        ...
        protected void gvTipoPierna_CancelRowEditing(object sender, ASPxStartRowEditingEventArgs e)
        {
            try
            {
                gvTipoPierna.Columns["Status"].Visible = true;
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoPierna_CancelRowEditing", "Aviso");
            }
        ...
        protected void gvTipoPierna_CellEditorInitialize(object sender, DevExpress.Web.ASPxGridViewEditorEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoPierna_CellEditorInitialize", "Aviso");
            }

            if(e.Column.FieldName == "IdTipoPaquete")
            {
                if (eGetPaquetes != null)
                    eGetPaquetes(sender, e);

                ASPxComboBox cmb = e.Editor as ASPxComboBox;
                cmb.DataSource = dtPaquetesActivos;
                cmb.ValueField = "IdTipoPaquete";
                cmb.ValueType = typeof(Int32);
                cmb.TextField = "Descripcion";
                cmb.DataBind();
                cmb.Items.Add("Ninguno", 0);
            }
        }
        ...
        protected void gvTipoPierna_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoPierna_RowDeleting", "Aviso");
            }
        ...
        protected void gvTipoPierna_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoPierna_RowUpdating", "Aviso");
            }
        }
        ...
        protected void gvTipoPierna_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoPierna_RowInserting", "Aviso");
            }
        ...
        protected void gvTipoPierna_StartRowEditing(object sender, DevExpress.Web.Data.ASPxStartRowEditingEventArgs e)
        {
            try
            {
                gvTipoPierna.SettingsText.PopupEditFormCaption = "Formulario de Edición";
            }
            catch (Exception ex)
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoPierna_StartRowEditing", "Aviso");
            }
        }
        ...
        protected void gvTipoPierna_RowValidating(object sender, DevExpress.Web.Data.ASPxDataValidationEventArgs e)
        {
            try
            {
                ...
                if (bDuplicado)
                {
                    AddError(e.Errors, gvTipoPierna.Columns["TipoPiernaDescripcion"], "Esta descripción de pierna ya existe, favor de validarlo.");
                }
            }
            catch (Exception ex)
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoPierna_RowValidating", "Aviso");
            }
        }
        ...
        protected void gvTipoPierna_CommandButtonInitialize(object sender, ASPxGridViewCommandButtonEventArgs e)
        {
            try
            {
                int iPos = 0;
        ...
        private const string sClase = "frmTipoPierna.aspx.cs";
        private const string sPagina = "frmTipoPierna.aspx";
        ...
        public event EventHandler eGetPaquetes;
        ...
        public DataTable dtPaquetesActivos
        {
            get
            {
                return (DataTable)ViewState["dtPaquetesActivos"];
            }
            set
            {
                ViewState["dtPaquetesActivos"] = value;
            }
        }
