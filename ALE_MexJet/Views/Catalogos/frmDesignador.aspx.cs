...
namespace ALE_MexJet.Views.Catalogos
{
    public partial class frmDesignador : System.Web.UI.Page, IViewCat
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                DrPermisos = Utils.ObtenerPermisos(Enumeraciones.Pantallas.Designador);
                ...
                gvDesignador.SettingsText.SearchPanelEditorNullText = "Ingrese la información a buscar";
                ...
                if (!IsPostBack)
                {
                    if (gvDesignador.VisibleRowCount < 1)
                    {
                        ...
                        gvDesignador.SettingsText.PopupEditFormCaption = "Formulario de Creacion";
        ...
        protected void gvDesignador_CancelRowEditing(object sender, ASPxStartRowEditingEventArgs e)
        {
            try
            {
                gvDesignador.Columns["Status"].Visible = true;
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvDesignador_CancelRowEditing", "Aviso");
            }
        }
        ...
        protected void gvDesignador_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvDesignador_CellEditorInitialize", "Aviso");
            }
        }
        ...
        protected void gvDesignador_RowDeleting(object sender, ASPxDataDeletingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvDesignador_RowDeleting", "Aviso");
            }
        }
        ...
        protected void gvDesignador_RowInserting(object sender, ASPxDataInsertingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvDesignador_RowInserting", "Aviso");
            }
        ...
        protected void gvDesignador_RowUpdating(object sender, ASPxDataUpdatingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvDesignador_RowUpdating", "Aviso");
            }
        ...
        protected void gvDesignador_StartRowEditing(object sender, ASPxStartRowEditingEventArgs e)
        {
            try
            {
                gvDesignador.SettingsText.PopupEditFormCaption = "Formulario de Edición";
            }
            catch (Exception ex)
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvDesignador_StartRowEditing", "Aviso");
            }
        }
        ...
        protected void gvDesignador_RowValidating(object sender, ASPxDataValidationEventArgs e)
        {
            try
            {
                ...
                if (bDuplicado)
                {
                    AddError(e.Errors, gvDesignador.Columns["Descripcion"], "Este Designador con esta clave ya existe, favor de validarlo.");
                }
            }
            catch (Exception ex)
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvDesignador_RowValidating", "Aviso");
            }
        }
        ...
        protected void btnNuevo_Click(object sender, EventArgs e)
        {
            try
            {
                gvDesignador.SettingsText.PopupEditFormCaption = "Formulario de Creación";
                gvDesignador.Columns["Status"].Visible = false;
                gvDesignador.AddNewRow();
            }
            catch (Exception ex)
        ...
        protected void gvDesignador_CommandButtonInitialize(object sender, ASPxGridViewCommandButtonEventArgs e)
        {
            try
            {
                int iPos = 0;
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvDesignador_CommandButtonInitialize", "Aviso");
            }
        }
        #endregion
        ...
        private const string sClase = "frmDesignador.aspx.cs";
        private const string sPagina = "frmDesignador.aspx";
