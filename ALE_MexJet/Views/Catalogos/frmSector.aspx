<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmSector.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmSector" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Sector</span>
                    </div>
                </div>
                 <div class="well-g">
                <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                           <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                                    ...
                                                    <asp:ListItem Text="Sector" Value="1"></asp:ListItem>
                ...
                <div class="row">
                    <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" OnUnload="Unnamed_Unload">
                            <ContentTemplate>
                                <div class="col-sm-12">
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvSector" runat="server" AutoGenerateColumns="False" 
                                        ClientInstanceName="gvSector" EnableTheming="True" KeyFieldName="IdSector"
                                        OnCellEditorInitialize="gvSector_CellEditorInitialize" OnRowDeleting="gvSector_RowDeleting"
                                        OnRowInserting="gvSector_RowInserting" OnRowUpdating="gvSector_RowUpdating" OnCommandButtonInitialize="gvSector_CommandButtonInitialize"
                                        OnStartRowEditing="gvSector_StartRowEditing" OnRowValidating="gvSector_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvSector_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="Sector" FieldName="SectorDescripcion" VisibleIndex="1">
                                                <PropertiesTextEdit>
                                                ...
                                                <EditFormSettings Caption="Sector"></EditFormSettings>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataCheckColumn Caption="¿Activo?" FieldName="Status" VisibleIndex="2">
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvSector">
