<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmTramoPactado.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmTramoPactado" %>
...
<script src="~/../../../JS/jquery/jquery-1.8.3.js"></script>
     <script type="text/javascript">
         ...
         function OnSaveClick(s, e) {
             gvTramoPactado.UpdateEdit();
         }

         var lastCountry = null;
         function OnCountryChanged(cmbCountry) {
             debugger;
             if (gvTramoPactado.GetEditor("IdDestino").InCallback())
                 lastCountry = cmbCountry.GetValue().toString();
             else
                 gvTramoPactado.GetEditor("IdDestino").PerformCallback(cmbCountry.GetValue().toString());
         }
         function OnEndCallback(s, e) {
             if (lastCountry) {
                 gvTramoPactado.GetEditor("IdDestino").PerformCallback(lastCountry);
                 lastCountry = null;
             }
         }
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Tramo Pactado</span>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                            <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                                <ContentTemplate>
                                    <div class="col-sm-12">
                                        <dx:ASPxGridView CssClass="FGrid" ID="gvTramoPactado" runat="server" AutoGenerateColumns="False" 
                                            ClientInstanceName="gvTramoPactado" EnableTheming="True" KeyFieldName="IdTramoPactado"
                                            OnCellEditorInitialize="gvTramoPactado_CellEditorInitialize" OnRowDeleting="gvTramoPactado_RowDeleting"
                                            OnRowInserting="gvTramoPactado_RowInserting" OnRowUpdating="gvTramoPactado_RowUpdating" OnCommandButtonInitialize="gvTramoPactado_CommandButtonInitialize"
                                            OnStartRowEditing="gvTramoPactado_StartRowEditing" OnRowValidating="gvTramoPactado_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                            Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvTramoPactado_CancelRowEditing">
                                            <ClientSideEvents EndCallback="function (s, e) {
                                                if (s.cpShowPopup)
                                                {
                                                    debugger;
                                                    delete s.cpShowPopup;
                                                    popup.SetWindowHeaderText(s.cpCaption);
                                                    lbl.SetText(s.cpText);
                                                    popup.Show();
                                                }
                                            }" />
                                            <Columns>
                                                <dx:GridViewDataComboBoxColumn Caption="Grupo Modelo" FieldName="IdGrupoModelo" ShowInCustomizationForm="True" Visible ="false" VisibleIndex="1">
                                                    ...
                                                    <EditFormSettings Visible="True" Caption="Grupo Modelo"></EditFormSettings>
                                                </dx:GridViewDataComboBoxColumn>
                                                <dx:GridViewDataTextColumn Caption="Grupo Modelo" FieldName="Descripcion" ShowInCustomizationForm="True" VisibleIndex="2">
                                                    <PropertiesTextEdit>
                                                ...
                                                <dx:GridViewDataComboBoxColumn Caption="Origen" FieldName="IdOrigen" ShowInCustomizationForm="True" Visible="false" VisibleIndex="3">
                                                     <PropertiesComboBox EnableSynchronization="False"
                                                                    ...
                                                                    <ClientSideEvents SelectedIndexChanged="function(s, e) { debugger; OnCountryChanged(s); }"></ClientSideEvents>
                                                                    <ValidationSettings ErrorDisplayMode="Text" CausesValidation="True" ErrorText="Error en la informaci&#243;n ingresada." ErrorTextPosition="Bottom" SetFocusOnError="True">
                                                                        <RequiredField IsRequired="True" ErrorText="El campo es requerido."></RequiredField>
                                                                    </ValidationSettings>
                                                                </PropertiesComboBox>
                                                    <EditFormSettings Visible="True" Caption="Origen"></EditFormSettings>
                                                </dx:GridViewDataComboBoxColumn>
                                                <dx:GridViewDataTextColumn Caption="Origen" FieldName="OrigenIATA" ShowInCustomizationForm="True" VisibleIndex="4">
                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                </dx:GridViewDataTextColumn>

                                                <dx:GridViewDataComboBoxColumn Caption="Destino" FieldName="IdDestino" ShowInCustomizationForm="True" Visible="false" VisibleIndex="5">
                                                   <PropertiesComboBox ValueType="System.Int32"
                                                    ...
                                                    <EditFormSettings Visible="True" Caption="Destino"></EditFormSettings>
                                                </dx:GridViewDataComboBoxColumn>
                                                <dx:GridViewDataTextColumn Caption="Destino" FieldName="DestinoIATA" ShowInCustomizationForm="True" VisibleIndex="6">
                                                    <EditFormSettings Visible="False"></EditFormSettings>
                                                </dx:GridViewDataTextColumn>
                                                <dx:GridViewDataTextColumn Caption="Tiempo de Vuelo" FieldName="TiempoDeVuelo" ShowInCustomizationForm="True" VisibleIndex="7">
                                                    ...
                                                    <EditFormSettings Visible="True" Caption="Tiempo de vuelo"></EditFormSettings>
                                                 </dx:GridViewDataTextColumn>
                                                

                                                <dx:GridViewDataCheckColumn Caption="¿Activo?" FieldName="Status" ShowInCustomizationForm="True" VisibleIndex="8">
                                                    <PropertiesCheckEdit ValueChecked="1" ValueType="System.Int32" ValueUnchecked="0">
                                                    </PropertiesCheckEdit>
                                                </dx:GridViewDataCheckColumn>
                                                <dx:GridViewCommandColumn ButtonType="Button" Caption="Acciones" ShowDeleteButton="True" ShowEditButton="True" ShowInCustomizationForm="True" VisibleIndex="9">
                                        ...
                                        <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvTramoPactado">
