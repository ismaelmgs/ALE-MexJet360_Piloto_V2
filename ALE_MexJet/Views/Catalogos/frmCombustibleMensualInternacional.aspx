<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmCombustibleMensualInternacional.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmCombustibleMensualInternacional" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnSaveClick(s, e) {
            gvCombustibleMensualInt.UpdateEdit();
        }
    </script>
    <dx:ASPxPanel ID="ASPxPanel1" runat="server" Width="100%" BackColor="White"  Style="border-radius: 21px;">
        <PanelCollection>
            <dx:PanelContent>
                ...
                <div class="col-md-12">
                    <span class="FTitulo">&nbsp;&nbsp;Combustible Mensual</span>
                </div>
                </div>
                <div class="well-g">
                <div class="row">
                                ...
                                <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4">
                                            <asp:DropDownList ID="ddlTipoBusqueda" runat="server" CssClass="combo" EnableTheming="True">
                                                ...
                                                <asp:ListItem Text="Importe" Value="3"></asp:ListItem>
                ...
                <div class="col-md-12" style="margin-left:-15px;width:103%;">
                    <asp:UpdatePanel runat="server" UpdateMode="Always" id="UpdCombustible" OnUnload="Unnamed_Unload">
                        <ContentTemplate>
                                <div class="col-sm-12">
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvCombustibleMensualInt" runat="server" AutoGenerateColumns="False" 
                                        ClientInstanceName="gvCombustibleMensualInt" EnableTheming="True" KeyFieldName="IdCombustibleMenInt"
                                        OnCellEditorInitialize="gvCombustibleMensualInt_CellEditorInitialize" OnRowDeleting="gvCombustibleMensualInt_RowDeleting"
                                        OnRowInserting="gvCombustibleMensualInt_RowInserting" OnRowUpdating="gvCombustibleMensualInt_RowUpdating" OnCommandButtonInitialize="gvCombustibleMensualInt_CommandButtonInitialize"
                                        OnStartRowEditing="gvCombustibleMensualInt_StartRowEditing" OnRowValidating="gvCombustibleMensualInt_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                        OnCancelRowEditing="gvCombustibleMensualInt_CancelRowEditing" Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="Año" FieldName="Anio" ShowInCustomizationForm="True" VisibleIndex="1" CellStyle-HorizontalAlign="Left">
                                            ...
                                            <dx:GridViewDataTextColumn Caption="Importe" FieldName="Importe" ShowInCustomizationForm="True" VisibleIndex="3" CellStyle-HorizontalAlign="Left">
                                                <PropertiesTextEdit MaxLength="12">
                                                                <ValidationSettings ErrorDisplayMode="Text" ErrorText="Error en la informaci&#243;n ingresada" ErrorTextPosition="Bottom" SetFocusOnError="True">
                                                                    <ErrorFrameStyle BackColor="Red"></ErrorFrameStyle>
                                                                    <RegularExpression ValidationExpression="(-?[0-9]+(\.[0-9]+)?)" ErrorText="El campo permite sólo números decimales o enteros."></RegularExpression>
                                                                    <RequiredField IsRequired="True" ErrorText="El campo es requerido"></RequiredField>
                                                                </ValidationSettings>
                                                            </PropertiesTextEdit>
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvCombustibleMensualInt">
