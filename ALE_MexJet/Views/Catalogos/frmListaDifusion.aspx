<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmListaDifusion.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmListaDifusion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <dx:ASPxPanel ID="pnlPrincipalListaDifusion" runat="server" Width="100%" BackColor="White" style="border-radius:21px;">
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Lista de Difusi&oacute;n</span>
                    </div>
                </div>
              <div class="well-g">
                <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                        <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                                        ...
                                                        <asp:ListItem Text="Lista" Value="1"></asp:ListItem>
                ...
                <div class="col-md-12" style="margin-left:-15px;width:103%;">
                    <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                        <ContentTemplate>
                                <div class="col-sm-12">
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvListaDifusion" runat="server" AutoGenerateColumns="False" 
                                        ClientInstanceName="gvListaDifusion" EnableTheming="True" KeyFieldName="IdListaDifusion"
                                        OnCellEditorInitialize="gvListaDifusion_CellEditorInitialize" OnRowDeleting="gvListaDifusion_RowDeleting"
                                        OnRowInserting="gvListaDifusion_RowInserting" OnRowUpdating="gvListaDifusion_RowUpdating" OnCommandButtonInitialize="gvListaDifusion_CommandButtonInitialize"
                                        OnStartRowEditing="gvListaDifusion_StartRowEditing" OnRowValidating="gvListaDifusion_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvListaDifusion_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="Lista" FieldName="Descripcion" ShowInCustomizationForm="True" VisibleIndex="1">
                                                ...
                                                <EditFormSettings Caption="Lista"></EditFormSettings>
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvListaDifusion">
