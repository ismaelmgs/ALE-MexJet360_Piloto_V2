<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmComisariatoProducto.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmComisariatoProducto" %>
...
<script src="~/../../../JS/jquery/jquery-1.8.3.js"></script>
    <script type="text/javascript">
        ...
        function OnSaveClick(s, e) {
            gvComisariatoProducto.UpdateEdit();
        }
    </script>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Comisariato-Producto</span>
                    </div>
                </div>
               <div class="well-g">
                <div class="row">
                ...
                <div class="col-md-12" style="margin-left:-15px;width:103%;">
                    <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload ="Unnamed_Unload">
                        <ContentTemplate>
                                ...
                                <div class="col-sm-12">                                    
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvComisariatoProducto" runat="server" AutoGenerateColumns="False" 
                                        ClientInstanceName="gvComisariatoProducto" EnableTheming="True" KeyFieldName="IdComisariatoProducto"
                                        OnCellEditorInitialize="gvComisariatoProducto_CellEditorInitialize" OnRowDeleting="gvComisariatoProducto_RowDeleting"
                                        OnRowInserting="gvComisariatoProducto_RowInserting" OnRowUpdating="gvComisariatoProducto_RowUpdating" OnCommandButtonInitialize="gvComisariatoProducto_CommandButtonInitialize"
                                        OnStartRowEditing="gvComisariatoProducto_StartRowEditing" OnRowValidating="gvComisariatoProducto_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvComisariatoProducto_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataComboBoxColumn FieldName="Comisariato" VisibleIndex="0">
                                                <EditFormSettings Visible="False"></EditFormSettings>
                                            </dx:GridViewDataComboBoxColumn>
                                            <dx:GridViewDataComboBoxColumn FieldName="IdComisariato" VisibleIndex="1" Visible="False">
                                                ...
                                                <EditFormSettings Visible="True" Caption="Comisariato"></EditFormSettings>
                                            </dx:GridViewDataComboBoxColumn>
                                            <dx:GridViewDataComboBoxColumn FieldName="Producto" VisibleIndex="2">
                                                <EditFormSettings Visible="False"></EditFormSettings>
                                            </dx:GridViewDataComboBoxColumn>
                                            <dx:GridViewDataComboBoxColumn FieldName="IdProducto" VisibleIndex="4" Visible="False">
                                                <PropertiesComboBox NullText="Seleccione una opción">
                                                    <ValidationSettings ErrorDisplayMode="Text" ErrorText="El campo contiene informaci&#243;n inv&#225;lida." ErrorTextPosition="Bottom" SetFocusOnError="True">
                                                        <RequiredField IsRequired="True" ErrorText="El campo es requerido."></RequiredField>
                                                    </ValidationSettings>
                                                ...
                                                <EditFormSettings Visible="True" Caption="Producto"></EditFormSettings>
                                            </dx:GridViewDataComboBoxColumn>
                                            <dx:GridViewDataTextColumn FieldName="Cantidad" VisibleIndex="5">
                                                <PropertiesTextEdit>
                                                    <ValidationSettings ErrorDisplayMode="Text" ErrorTextPosition="Bottom">
                                                        <RegularExpression ErrorText=" campo contiene informaci&#243;n inv&#225;lida." ValidationExpression="[0-9]*"></RegularExpression>

                                                        <RequiredField IsRequired="True" ErrorText="El campo es requerido."></RequiredField>
                                                    </ValidationSettings>
                                                </PropertiesTextEdit>
                                                <EditFormSettings Caption="Cantidad"></EditFormSettings>
                                            </dx:GridViewDataTextColumn>
                                            <dx:GridViewDataCheckColumn Caption="¿Activo?" FieldName="Status" VisibleIndex="6">
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvComisariatoProducto">
