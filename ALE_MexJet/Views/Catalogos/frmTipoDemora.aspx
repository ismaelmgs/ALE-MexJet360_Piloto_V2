<%@ Page Title="" Language="C#" MasterPageFile="~/ALE_Main.Master" AutoEventWireup="true" CodeBehind="frmTipoDemora.aspx.cs" UICulture="es" Culture="es-MX" Inherits="ALE_MexJet.Views.Catalogos.frmTipoDemora" %>
        ...
        <PanelCollection>
            <dx:PanelContent>
                <div class="row header1">
                    <div class="col-md-12">
                        <span class="FTitulo">&nbsp;&nbsp;Tipo Demora</span>
                    </div>
                </div>
                <div class="well-g">
                <div class="row">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-lg-4">
                                        <asp:DropDownList runat="server" CssClass="combo" ID="ddlTipoBusqueda">
                                                    ...
                                                    <asp:ListItem Text="Tipo de demora" Value="2"></asp:ListItem>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" style="margin-left: -15px; width: 103%;">
                        <asp:UpdatePanel runat="server" UpdateMode="Always" OnUnload="Unnamed_Unload">
                            <ContentTemplate>
                                <div class="col-sm-12">
                                    <dx:ASPxGridView CssClass="FGrid" ID="gvTipoDemora" runat="server" AutoGenerateColumns="False"
                                        ClientInstanceName="gvTipoDemora" EnableTheming="True" KeyFieldName="IdTipoDemora"
                                        OnCellEditorInitialize="gvTipoDemora_CellEditorInitialize" OnRowDeleting="gvTipoDemora_RowDeleting"
                                        OnRowInserting="gvTipoDemora_RowInserting" OnRowUpdating="gvTipoDemora_RowUpdating" OnCommandButtonInitialize="gvTipoDemora_CommandButtonInitialize"
                                        OnStartRowEditing="gvTipoDemora_StartRowEditing" OnRowValidating="gvTipoDemora_RowValidating" Styles-Header-HorizontalAlign ="Center"
                                        Theme="Office2010Black" Width="100%" StylesPopup-EditForm-ModalBackground-Opacity="90" OnCancelRowEditing="gvTipoDemora_CancelRowEditing">
                                        ...
                                        <Columns>
                                            <dx:GridViewDataTextColumn Caption="Tipo de Demora" FieldName="TipoDemoraDescripcion" ShowInCustomizationForm="True" VisibleIndex="1">
                                                ...
                                                <EditFormSettings Caption="Tipo de demora"></EditFormSettings>
                                    ...
                                    <dx:ASPxGridViewExporter ID="Exporter" runat="server" GridViewID="gvTipoDemora">
