...
{
    public partial class frmComisariato : System.Web.UI.Page, IViewCat
    {
        #region EVENTOS
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                DrPermisos = Utils.ObtenerPermisos(Enumeraciones.Pantallas.Comisariato);
                LoadActions(DrPermisos);
                gvComisariato.Columns["Status"].Visible = true;
                oPresenter = new Comisariato_Presenter(this, new DBComisariato());
                ...
                if (!IsPostBack)
                {
                    if (gvComisariato.VisibleRowCount < 1)
                    {

                        gvComisariato.SettingsText.PopupEditFormCaption = "Formulario de Creación";
                        gvComisariato.Columns["Status"].Visible = false;
        ...
        protected void gvComisariato_CancelRowEditing(object sender, ASPxStartRowEditingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvComisariato_CancelRowEditing", "Aviso");
            }
        }
        ...
        protected void gvComisariato_RowValidating(object sender, ASPxDataValidationEventArgs e)
        {
            try
            {
                ...
                if (bDuplicado)
                {
                    AddError(e.Errors, gvComisariato.Columns["Descripcion"], "Este comisariato ya existe, favor de validarlo.");
                }
            }
            catch (Exception ex)
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvComisariato_RowValidating", "Aviso");
            }
        }
        ...
        protected void gvComisariato_CommandButtonInitialize(object sender, ASPxGridViewCommandButtonEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvComisariato_CommandButtonInitialize", "Aviso");
            }
        }
        #endregion
        ...
        public void LoadObjects(DataTable dtObject)
        {
            try
            {
                ...
                gvComisariato.DataSource = dtObject;
        ...
        private const string sClase = "frmComisariato.aspx.cs";
        private const string sPagina = "frmComisariato.aspx";

        Comisariato_Presenter oPresenter;
