...
namespace ALE_MexJet.Views.Catalogos
{
    public partial class frmTipoCambio : System.Web.UI.Page, IViewCat
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                DrPermisos = Utils.ObtenerPermisos(Enumeraciones.Pantallas.TipoCambio);
                ...
                gvTipoCambio.SettingsText.SearchPanelEditorNullText = "Ingrese la información a buscar";
                ...
                if (!IsPostBack)
                {
                    if (gvTipoCambio.VisibleRowCount < 1)
                    {
                        ...
                        gvTipoCambio.SettingsText.PopupEditFormCaption = "Formulario de Creación";
        ...
        protected void gvTipoCambio_CancelRowEditing(object sender, ASPxStartRowEditingEventArgs e)
        {
            try
            {
                gvTipoCambio.Columns["Status"].Visible = true;
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoCambio_CancelRowEditing", "Aviso");
            }
        ...
        protected void gvTipoCambio_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoCambio_CellEditorInitialize", "Aviso");
            }
        }
        ...
        protected void gvTipoCambio_RowDeleting(object sender, ASPxDataDeletingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoCambio_RowDeleting", "Aviso");
            }
        }
        ...
        protected void gvTipoCambio_RowInserting(object sender, ASPxDataInsertingEventArgs e)
        {
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoCambio_RowInserting", "Aviso");
            }
        ...
        protected void gvTipoCambio_StartRowEditing(object sender, ASPxStartRowEditingEventArgs e)
        {
            try
            {
                gvTipoCambio.SettingsText.PopupEditFormCaption = "Formulario de Edición";
            }
            catch (Exception ex)
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoCambio_StartRowEditing", "Aviso");
            }
        }
        ...
        protected void gvTipoCambio_RowValidating(object sender, ASPxDataValidationEventArgs e)
        {
            try
            {
                ...
                if (bDuplicado)
                {
                    AddError(e.Errors, gvTipoCambio.Columns["Mes"], "Tipo Cambio ya existe, favor de validarlo.");
                }
            }
            catch (Exception ex)
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoCambio_RowValidating", "Aviso");
            }
        }
        ...
        protected void gvTipoCambio_CommandButtonInitialize(object sender, ASPxGridViewCommandButtonEventArgs e)
        {
            try
            {
                int iPos = 0;
            ...
            {
                Utils.SaveErrorEnBitacora(mpeMensaje, ex.Message, sPagina, sClase, "gvTipoCambio_CommandButtonInitialize", "Aviso");
            }
        }
        ...
        private const string sClase = "frmTipoCambio.aspx.cs";
        private const string sPagina = "frmTipoCambio.aspx";
