...
namespace ALE_MexJet.Objetos
{
    ...
    public class GrupoModelo : BaseObjeto
    {
        private int _iId = -1;
        public string _sDescripcion = string.Empty;
        private int _iStatus = 1;
        private int _iConsumoGalones = 1;
        private decimal _dTarifa = 0;
        private int _iNoPasajeros = 0;
        ...
        [Display(Name = "Consumo en Galones "), Required]
        public int iGalones { get { return _iConsumoGalones; } set { _iConsumoGalones = value; } }

        public decimal dTarifa { get { return _dTarifa; } set { _dTarifa = value; } }

        public int iNoPasajeros { get { return _iNoPasajeros; } set { _iNoPasajeros = value; } }
