...
namespace ALE_MexJet.Objetos
{
    ...
    public class Flota : BaseObjeto
    {
        ...
        private string _iFlotaCU2;
        private string _sDescripcionFlotaCU2;
        private int _iFlotaSENEAM = 1;
        private int _iFlotaAPHIS = 1;
        ...
        [Display(Name = "La descripcion es requerida", AutoGenerateField = true)]
        public virtual string sDescripcion { get { return _sDescripcion; } set { _sDescripcion = value; } }

        public string iFlotaCU2 { get { return _iFlotaCU2; } set { _iFlotaCU2 = value; } }
        public string sDescripcionFlotaCU2 { get { return _sDescripcionFlotaCU2; } set { _sDescripcionFlotaCU2 = value; } }
        public int iFlotaSENEAM { get { return _iFlotaSENEAM; } set { _iFlotaSENEAM = value; } }
        public int iFlotaAPHIS { get { return _iFlotaAPHIS; } set { _iFlotaAPHIS = value; } }
