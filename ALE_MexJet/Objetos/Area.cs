...
namespace ALE_MexJet.Objetos
{
    ...
    public class Area : BaseObjeto
    {
        private int _iId = -1;
        public string _sDescripcion = string.Empty;
        public string _sAreaEmailCC = string.Empty;
        public string _sAreaEmail = string.Empty;
        ...
        [Required(AllowEmptyStrings = false, ErrorMessage = "El campo Marca es obligatorio")]
        [Display(Name = "El comisariato es requerido", AutoGenerateField = true)]
        public virtual string sAreaEmailCC { get { return _sAreaEmailCC; } set { _sAreaEmailCC = value; } }

        [Required(AllowEmptyStrings = false, ErrorMessage = "El campo Marca es obligatorio")]
        [Display(Name = "El comisariato es requerido", AutoGenerateField = true)]
        public virtual string sAreaEmail { get { return _sAreaEmail; } set { _sAreaEmail  = value; } }
