...
{
    public class Titulo_Presenter: BasePresenter<IViewCat>
    {
        private readonly DBTitulo oIGestCat;

        public Titulo_Presenter(IViewCat oView, DBTitulo oGC)
            : base(oView)
        {
            oIGestCat = oGC;
        }
        ...
        protected override void SaveObj_Presenter(object sender, EventArgs e)
        {
            try
            {
                Titulo oTitulo = oCatalogo;
                int id = oIGestCat.DBUpdate(oTitulo);
                if (id > 0)
                {
        ...
        protected override void NewObj_Presenter(object sender, EventArgs e)
        {
            ...
            {
                Titulo oTitulo = oCatalogo;
                int id = oIGestCat.DBSave(oTitulo);
                if (id > 0)
                {
        ...
        protected override void DeleteObj_Presenter(object sender, EventArgs e)
        {
            ...
            {
                Titulo oTitulo = oCatalogo;
                int id = oIGestCat.DBDelete(oTitulo);
                if (id > 0)
                {
            ...
            get
            {
                ...
                switch (oIView.eCrud)
                {
                    ...
                    case Enumeraciones.TipoOperacion.Actualizar:
                        ...
                        oTitulo.iId = eU.Keys[0].S().I();
                        oTitulo.sDescripcion = eU.NewValues["TituloDescripcion"].S();
                        oTitulo.iStatus = eU.NewValues["Status"].S().I();

                        break;
                    case Enumeraciones.TipoOperacion.Validar:
                        ASPxDataValidationEventArgs eV = (ASPxDataValidationEventArgs)oIView.oCrud;

                        oTitulo.sDescripcion = eV.NewValues["TituloDescripcion"].S();
                        oTitulo.iStatus = eV.NewValues["Status"].S().I();
                        break;
                    case Enumeraciones.TipoOperacion.Eliminar:
                        ASPxDataDeletingEventArgs eD = (ASPxDataDeletingEventArgs)oIView.oCrud;
                        oTitulo.iId = eD.Keys[0].S().I();
                        oTitulo.sDescripcion = eD.Values["TituloDescripcion"].S();
                        break;
                }
