...
{
    public class TipoContacto_Presenter: BasePresenter<IViewCat>
    {
        private readonly DBTipoContacto oIGestCat;

        public TipoContacto_Presenter(IViewCat oView, DBTipoContacto oGC)
            : base(oView)
        {
            oIGestCat = oGC;
        }
        ...
        protected override void SaveObj_Presenter(object sender, EventArgs e)
        {
            try
            {
                TipoContacto oTipoContacto = oCatalogo;
                int id = oIGestCat.DBUpdate(oTipoContacto);
                if (id > 0)
                {
        ...
        protected override void NewObj_Presenter(object sender, EventArgs e)
        {
            ...
            {
                TipoContacto oTipoContacto = oCatalogo;
                int id = oIGestCat.DBSave(oTipoContacto);
                if (id > 0)
                {
        ...
        protected override void DeleteObj_Presenter(object sender, EventArgs e)
        {
            ...
            {
                TipoContacto oTipoContacto = oCatalogo;
                int id = oIGestCat.DBDelete(oTipoContacto);
                if (id > 0)
                {
        ...
        private TipoContacto oCatalogo
        {
            get
            {
                TipoContacto oTipoContacto = new TipoContacto();
                switch (oIView.eCrud)
                {
                    case Enumeraciones.TipoOperacion.Insertar:
                        ASPxDataInsertingEventArgs eI = (ASPxDataInsertingEventArgs)oIView.oCrud;
                        oTipoContacto.iId = 0;
                        oTipoContacto.sDescripcion = eI.NewValues["TipoContactoDescripcion"].S();
                        oTipoContacto.iStatus = 1;

                        break;
                    case Enumeraciones.TipoOperacion.Actualizar:
                        ASPxDataUpdatingEventArgs eU = (ASPxDataUpdatingEventArgs)oIView.oCrud;

                        oTipoContacto.iId = eU.Keys[0].S().I();
                        oTipoContacto.sDescripcion = eU.NewValues["TipoContactoDescripcion"].S();
                        oTipoContacto.iStatus = eU.NewValues["Status"].S().I();

                        break;
                    case Enumeraciones.TipoOperacion.Validar:
                        ASPxDataValidationEventArgs eV = (ASPxDataValidationEventArgs)oIView.oCrud;

                         oTipoContacto.sDescripcion = eV.NewValues["TipoContactoDescripcion"].S();
                        oTipoContacto.iStatus = eV.NewValues["Status"].S().I();
                        break;
                    case Enumeraciones.TipoOperacion.Eliminar:
                        ASPxDataDeletingEventArgs eD = (ASPxDataDeletingEventArgs)oIView.oCrud;
                        oTipoContacto.iId = eD.Keys[0].S().I();
                        oTipoContacto.sDescripcion = eD.Values["TipoContactoDescripcion"].S();
                        break;
                }

                return oTipoContacto;
            }
        }
        private bool bValidaActualizacion
        {
            get
            {
                ...
                bValida = eU.NewValues["TipoContactoDescripcion"].S().ToUpper() != eU.OldValues["TipoContactoDescripcion"].S().ToUpper();
