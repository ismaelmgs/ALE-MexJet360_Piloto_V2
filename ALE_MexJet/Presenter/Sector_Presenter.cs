...
{
    public class Sector_Presenter: BasePresenter<IViewCat>
    {
        private readonly DBSector oIGestCat;

        public Sector_Presenter(IViewCat oView, DBSector oGC)
            : base(oView)
        {
            oIGestCat = oGC;
        }
        ...
        protected override void SaveObj_Presenter(object sender, EventArgs e)
        {
            try
            {
                Sector oSector = oCatalogo;
                int id = oIGestCat.DBUpdate(oSector);
                if (id > 0)
                {
        ...
        protected override void NewObj_Presenter(object sender, EventArgs e)
        {
            ...
            {
                Sector oSector = oCatalogo;
                int id = oIGestCat.DBSave(oSector);
                if (id > 0)
                {
        ...
        protected override void DeleteObj_Presenter(object sender, EventArgs e)
        {
            ...
            {
                Sector oSector = oCatalogo;
                int id = oIGestCat.DBDelete(oSector);
                if (id > 0)
                {
            ...
            get
            {
                ...
                switch (oIView.eCrud)
                {
                    case Enumeraciones.TipoOperacion.Insertar:
                        ...
                        oSector.iId = 0;
                        oSector.sDescripcion = eI.NewValues["SectorDescripcion"].S();
                        oSector.iStatus = 1;
                    ...
                    case Enumeraciones.TipoOperacion.Actualizar:
                        ...
                        oSector.iId = eU.Keys[0].S().I();
                        oSector.sDescripcion = eU.NewValues["SectorDescripcion"].S();
                        oSector.iStatus = eU.NewValues["Status"].S().I();

                        break;
                    case Enumeraciones.TipoOperacion.Validar:
                        ASPxDataValidationEventArgs eV = (ASPxDataValidationEventArgs)oIView.oCrud;

                        oSector.sDescripcion = eV.NewValues["SectorDescripcion"].S();
                        oSector.iStatus = eV.NewValues["Status"].S().I();
                        break;
                    case Enumeraciones.TipoOperacion.Eliminar:
                        ASPxDataDeletingEventArgs eD = (ASPxDataDeletingEventArgs)oIView.oCrud;
                        oSector.iId = eD.Keys[0].S().I();
                        oSector.sDescripcion = eD.Values["SectorDescripcion"].S();
                        break;
                }
        ...
        private bool bValidaActualizacion
        {
            get
            {
                ...
                bValida = eU.NewValues["SectorDescripcion"].S().ToUpper() != eU.OldValues["SectorDescripcion"].S().ToUpper();
